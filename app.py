...
from src.expenis.ui.datasource import CARD_STYLE, DataStore
...
from src.expenis.ui.datasource import DataStore, get_turbines
from src.expenis.ui.views import Histogram, Indicators, Table
...
App(data_store=ds, views=[Indicators, Histogram, Table], title="Windturbine Explorer").servable()
